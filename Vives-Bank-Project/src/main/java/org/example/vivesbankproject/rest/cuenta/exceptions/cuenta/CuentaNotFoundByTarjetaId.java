...
public class CuentaNotFoundByTarjetaId extends CuentaException {

    /**
     * Constructor para crear una instancia de {@code CuentaNotFoundByTarjetaId} con un mensaje que indica
     ...
     */
    public CuentaNotFoundByTarjetaId(String id) {
